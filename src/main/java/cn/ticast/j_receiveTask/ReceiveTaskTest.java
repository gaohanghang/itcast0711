package cn.ticast.j_receiveTask;
...
//        InputStream inputStreamPng = this.getClass().getResourceAsStream("diagrams/exclusiveGateWay.png");
        ...
        Deployment deployment = processEngine.getRepositoryService()//与流程定义和部署对象相关的Sevice
                ...
                .name("接收活动任务")//添加部署的名称
                .addClasspathResource("diagrams/j_receiveTask/receiveTask.bpmn")//
                .addClasspathResource("diagrams/j_receiveTask/receiveTask.png")
                .deploy();//完成部署
    ...
    public void setProcessEngine(){
        ...
        processEngine.getRuntimeService()//
                        .setVariable(execution1.getId(),"汇总当日销售额", 210000);
