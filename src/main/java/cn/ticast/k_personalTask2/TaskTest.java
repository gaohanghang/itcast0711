package cn.ticast.k_personalTask2;
...
public class TaskTest {
    ...
    public void deploymentProcessDefinition_inputStream(){
        ...
        Deployment deployment = processEngine.getRepositoryService()//与流程定义和部署对象相关的Sevice
                ...
                .name("任务")//添加部署的名称
                .addClasspathResource("diagrams/k_personalTask2/task.bpmn")//
                .addClasspathResource("diagrams/k_personalTask2/task.png")
                .deploy();//完成部署
    ...
    public void setProcessEngine(){
        //流程定义的key
        String processDefinitionKey = "task1";
