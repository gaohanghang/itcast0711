package cn.ticast.k_personalTask;
...
public class TaskTest {
    ...
    public void deploymentProcessDefinition_inputStream(){
        ...
        Deployment deployment = processEngine.getRepositoryService()//与流程定义和部署对象相关的Sevice
                ...
                .name("任务")//添加部署的名称
                .addClasspathResource("diagrams/k_personalTask/task.bpmn")//
                .addClasspathResource("diagrams/k_personalTask/task.png")
                .deploy();//完成部署
    ...
    public void setProcessEngine(){
        ...
        /**启动流程实例的同时，设置流程变量，使用流程变量用来指定任务的办理人，对应task.bpmn文件中#{userID}*/
